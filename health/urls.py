...
urlpatterns = [
    ...
    path('symptomlog/', views.symptomlog_list, name='symptomlog_list'),
    path('symptomlog/add/', views.symptomlog_create, name='symptomlog_create'),
    path('symptomlog/<int:pk>/delete/', views.symptomlog_delete, name='symptomlog_delete'),
